       ...
       <div class="lg:col-span-2">
           ...
           <div class="card mt-2">
               <div class="card-body flex text-gray-500 font-bold">
                    @if($this->previous)
                    <a wire:click="changeLesson({{$this->previous}} )" class="cursor-pointer">前のトピック</a>
                    @endif
                    @if($this->next)
                    <a wire:click="changeLesson({{$this->next}} )" class="ml-auto cursor-pointer">次のトピック</a>
                    @endif
               </div>
           </div>
       ...
       <div class="card">
           <div class="card-body">
               ...
               <div class="flex items-center mt-4 cursor-pointer">
                   <figure><img class="w-12 h-12 object-cover rounded-full mr-4" src="{{$course->teacher->profile_photo_url}}" alt=""></figure>
                   <div>
               ...
               <ul>
                   ...
                   <li class="text-gray-600 mb-4">
                       <a class="font-bold text-base inline-block mb-2">
                           {{$section->name}}
                       </a>
                       <ul>
