<section class="my-4">
    <h1 class="font-bold text-3xl text-gray-800 mb-2">ユーザーレビュー</h1>

    @can('enrolled',$course)
        <article class="mb-4">
            @can('valued',$course)
            <textarea wire:model="comment" class="form-input w-full" rows="3" placeholder="コメントを入力できます"></textarea>
            @error('comment')
