  ...
  <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-12">
      ...
      <div class="card text-gray-600">
          <div class="card-body">
              ...
              <hr>
              <p class="text-sm mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit eveniet illo impedit amet ad non nihil. Quisquam quia, illo inventore ea eaque alias doloremque nemo nisi, iste ut sequi sapiente! <a class="text-red-500 font-bold" href=""></a></p>
          </div>
      </div>
  </div>
</x-app-layout>
